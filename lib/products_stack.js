...
(function() {
  var ProductsSearcher, ProductsStack, VersionsStack, async, fs, path, _,
  ...
  module.exports = ProductsStack = (function() {
    function ProductsStack(options) {
      ...
      this._unknownProductNotify = __bind(this._unknownProductNotify, this);
      this._getProduct = __bind(this._getProduct, this);
      this._getVersionsStackAllProducts = __bind(this._getVersionsStackAllProducts, this);
