...
(function() {
  var BaseExecutor, ComponentFactory, EventEmitter, ProductsStack, _, async,
  ...
  module.exports = ComponentFactory = (function(superClass) {
    extend(ComponentFactory, superClass);
    ...
    function ComponentFactory(options) {
      ...
      this._checkArgs = bind(this._checkArgs, this);
      this._buildInterface = bind(this._buildInterface, this);
      this._getStepsImplementations = bind(this._getStepsImplementations, this);
      this._resultHubBuilder = bind(this._resultHubBuilder, this);
      this._initFactory = bind(this._initFactory, this);
      this.buildInterface = bind(this.buildInterface, this);
      this.initFactory = bind(this.initFactory, this);
    ...
    ComponentFactory.prototype._resultHubBuilder = function(cb) {
      var cb_step, listeners_step, ref, steps;
      ref = this._getStepsImplementations(cb), cb_step = ref.cb_step, listeners_step = ref.listeners_step;
