...
(function() {
  var CodeLoader, VersionsSearcher, VersionsStack, async, fs, path, semver, _,
  ...
  module.exports = VersionsStack = (function() {
    function VersionsStack(options) {
      ...
      this._rangeErrorNotify = __bind(this._rangeErrorNotify, this);
      this._nonSemverVersionGeted = __bind(this._nonSemverVersionGeted, this);
      this._getMergePlan = __bind(this._getMergePlan, this);
      this._mergeImplementation = __bind(this._mergeImplementation, this);
      this._buildVersion = __bind(this._buildVersion, this);
      this._getSortedVersions = __bind(this._getSortedVersions, this);
      this._initStack = __bind(this._initStack, this);
      this.buildVersion = __bind(this.buildVersion, this);
      this.initStack = __bind(this.initStack, this);
    ...
    VersionsStack.prototype._mergeImplementation = function(plan) {
      var body, name, result, step, _i, _len, _ref, _ref1;
      result = {
        executes: {},
        resolved_at: {}
      };
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        step = _ref[_i];
        _ref1 = this._content_cache_[step];
        for (name in _ref1) {
          body = _ref1[name];
    ...
    VersionsStack.prototype._rangeErrorNotify = function(version, kind) {
      var _base;
      return typeof (_base = this._logger_).warn === "function" ? _base.warn("WARN: version |" + version + "| to " + kind + ", known versions:\n|" + (this._known_versions_dict_.join(', ')) + "|") : void 0;
    };
